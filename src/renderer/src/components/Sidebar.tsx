  ...
  return (
    <div className="w-[240px] h-screen bg-[#333333] text-[#FFFFFF] flex flex-col sticky top-0 left-0 transition-all duration-300 shadow-lg">
      <div className="p-6 border-b border-gray-600 flex items-center justify-between">
        <h1 className="text-xl font-black text-white tracking-widest flex items-center gap-2 font-exo2">
          HISAB-KHATA
        </h1>
      </div>
      ...
      <div className="p-4 border-t border-gray-600">
        <div className="bg-[#FEFEFE0F] rounded p-3 flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold text-xs uppercase shadow-active/20 shadow-md">
            AA
          </div>
          <div className="flex-1 overflow-hidden">
            <p className="text-[12px] font-bold text-white truncate uppercase tracking-tighter">Abdur Rahman</p>
            <p className="text-[10px] text-gray-400 truncate uppercase mt-0.5">Administrator</p>
          </div>
        </div>
      </div>
    </div>
