...
export const baseButtonStyles =
    "bg-[#333333] w-full text-white font-black py-3 px-6 rounded  tracking-wider transition-all hover:shadow-lg disabled:cursor-not-allowed disabled:bg-gray-400";
